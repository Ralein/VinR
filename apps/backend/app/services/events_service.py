...
async def search_events(
    ...
    # ⚡ Bolt Optimization: Parallelize independent external API calls to reduce total latency.
    # By using asyncio.gather, we execute the Google Places and Eventbrite requests concurrently,
    # cutting the waiting time roughly by the duration of the faster request.
