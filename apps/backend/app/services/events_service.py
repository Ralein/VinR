...
async def search_events(
    ...
    # Fire both API calls
    # ⚡ Bolt Optimization: Use asyncio.gather to fetch from both APIs concurrently
    # This reduces overall latency from sum(google_time, eb_time) to max(google_time, eb_time)
