...
async def search_events(
    ...
    # ⚡ Bolt: Run external API calls concurrently to reduce overall latency
    # Expected impact: Reduces total latency to max(Google API, Eventbrite API) instead of sum of both
