...
async def search_events(
    ...
    # ⚡ Bolt: Parallelize API calls using asyncio.gather to reduce overall latency.
    # Expected impact: Reduces function response time by bounded max latency rather than sum.
